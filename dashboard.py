...
PLATFORMS = [
    ...
    {"id":"zhipu","name":"智谱AI","api_url":"https://open.bigmodel.cn/api/llm/balance","color":"#10B981","check":lambda s,k,u:_check_zhipu(s,k,u)},
    ...
    {"id":"openai","name":"OpenAI","api_url":"https://api.openai.com/v1/dashboard/billing/credit_grants","color":"#111827","check":lambda s,k,u:_check_openai(s,k,u)},
    {"id":"qwen","name":"阿里通义千问","api_url":"https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions","color":"#FF6A00","check":lambda s,k,u:_check_qwen(s,k,u)},
]
